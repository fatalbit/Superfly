...
RUN cd /home/ctf/protobuf && ./configure && make -j `nproc` && make install && ldconfig
...
EXPOSE 8888
CMD ["socat", "-T60", "TCP-LISTEN:8888,reuseaddr,fork", "EXEC:\"LD_PRELOAD=./libsuperfly.so /usr/bin/python\",pty,stderr"]
